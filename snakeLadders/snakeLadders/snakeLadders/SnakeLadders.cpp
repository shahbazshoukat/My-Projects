...
void SnakeLadders::drawBoard()
{
	...
	pawnTexture.loadFromFile("images\\pawn.png");
	diceTexture.loadFromFile("images\\dice.png");
	rollDiceTexture.loadFromFile("images\\rollDice.png");
