...
void Game::run()
{
	...
	players.setPosition(sf::Vector2f(600, 300));
	about.setPosition(sf::Vector2f(600, 400));
	continueSp.setPosition(sf::Vector2f(600, 200));
	startGame.setPosition(sf::Vector2f(600, 250));
	help.setPosition(sf::Vector2f(600, 350));
	exit.setPosition(sf::Vector2f(600, 450));
	int flag = 1;
